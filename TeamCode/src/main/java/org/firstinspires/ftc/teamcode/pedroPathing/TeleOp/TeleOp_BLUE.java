...
public class TeleOp_BLUE extends LinearOpMode {
    ...
    private final Waypoint[] pontosSituacao1 = {
            new Waypoint(-35, 750), // Média de -170 a -120 (valores invertidos para o lado azul)
            new Waypoint(-90,  525), // Média de -110 a -70
            new Waypoint(-135,  300), // Média de -65 a -25
            new Waypoint(179.9,    50),  // Média de -20 a 20
            new Waypoint(135,   -200),  // Média de 25 a 65
            new Waypoint(90,   -470),  // Média de 70 a 110
            new Waypoint(32.5, -750)  // Média de 115 a 180
    };

    // y > 60 && x > 72
    private final Waypoint[] pontosSituacao2 = {
            new Waypoint(-105,  750), // Média de -90 a -60
            new Waypoint(-135,  550), // Média de -65 a -25
            new Waypoint(179.9,    225), // Média de -20 a 20
            new Waypoint(135,   -30),   // Média de 25 a 65
            new Waypoint(90,   -255),  // Média de 70 a 110
            new Waypoint(45,  -515),  // Média de 115 a 155
            new Waypoint(-32.5, -750)  // Média do limite composto (160 a -95 passando por 180) -> 160 a 265
    };

    // y > 60 && x <= 72
    private final Waypoint[] pontosSituacao3 = {
            new Waypoint(-62.5, 750), // Média de -135 a -100
            new Waypoint(-112.5,  425), // Média de -90 a -45
            new Waypoint(179.9,      130), // Média de -20 a 20
            new Waypoint(135,     -130),  // Média de 25 a 65
            new Waypoint(90,     -385),  // Média de 70 a 110
            new Waypoint(45,    -660),  // Média de 115 a 155
            new Waypoint(-15,    -750)   // Média do limite composto (160 a -130 passando por 180) -> 160 a 230
    };

    // y <= 50
    private final Waypoint[] pontosSituacao4 = {
            new Waypoint(-77.5, 750), // Média de -135 a -70
            new Waypoint(-135,    650), // Média de -65 a -25
            new Waypoint(179.9,      350), // Média de -20 a 20
            new Waypoint(135,     100), // Média de 25 a 65
            new Waypoint(90,     -190),  // Média de 70 a 110
            new Waypoint(40,    -435),  // Média de 115 a 165
            new Waypoint(-12.5,  -750)   // Média do limite composto (170 a -145 passando por 180) -> 170 a 215
    };
