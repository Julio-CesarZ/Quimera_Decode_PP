...
@TeleOp(name = "TeleOp BLUE - Perto", group = "TeleOp")
public class TeleOp_BLUE_Perto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (azul) {
            startingPoseTeleop = new Pose(60.17, 106.49, Math.toRadians(180));
